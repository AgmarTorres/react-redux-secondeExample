                ...
                <div className="item" >
                    <div className='users'>
                        <div className='user-repository'>
                            <label className="info-name">Repository: </label><br/> <span className = "name">{item.name}</span>
                        </div>
                        <div className="user-name">
                            <label className="info-name">Author:</label> <span className = "username">{item.owner.login} </span> 
                        </div>
                    </div>
                    <div className='features'>
                        ...
                        <div>
                            <PopUp className="btn" url={`https://api.github.com/repos/${item.full_name}/pulls`}>view</PopUp>
                        </div>
                    </div>
                </div>
                <div className='info' >
